      ...
      <header className="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white border-b border-gray-200 text-sm py-3 sm:py-0 dark:bg-neutral-800 dark:border-neutral-700">
        ...
        >
          <div className="flex items-center justify-center">
            ...
            <h3 className="text-xl pb-2 px-2 font-bold">
              Genify<span className="font-bold text-3xl text-primary">.</span>ai
            </h3>
          </div>
          <div
        ...
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
          ...
          <div className="mt-5 max-w-3xl text-center mx-auto">
            <p className="text-lg text-gray-600 dark:text-neutral-400">
              No more writer's block. Share your ideas, hit a button, and watch
              as our AI writing tools generate the copy you need. It's that
              simple!.
            </p>
          </div>
